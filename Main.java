package javaLabEvaluation;
    ...
    public class Main {
        public static void main(String[] args) {
            ...
            Book book1 = new Book("Moth Smoke", "Mohsin Hamid",2000, 24);
            Book book3 = new Book("Moth Smoke", "Mohsin Hamid",2000, 24);
...
//
            ...
            System.out.println("Compare two library items");
            boolean equal = book1.equals(book3);
